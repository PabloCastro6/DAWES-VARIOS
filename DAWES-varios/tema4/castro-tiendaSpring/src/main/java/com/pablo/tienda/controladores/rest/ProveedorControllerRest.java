...
public class ProveedorControllerRest {
	...
	public ResponseEntity insertarProveedor(@RequestBody ProveedorEntity proveedor)
			throws ClassNotFoundException, SQLException, NamingException {

		proveedoresService.insertarProveedores(proveedor.getNombre(), proveedor.getContacto(), proveedor.getTelefono(),
				proveedor.getCorreoElectronico(), proveedor.getDireccion(), proveedor.getActivo().toString());
	...
	public ResponseEntity borrarProveedor(@PathVariable("id") Integer id)
			throws ClassNotFoundException, SQLException, NamingException {
