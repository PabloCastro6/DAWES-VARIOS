...
<h3> Actualizar Proveedores </h3>
	<div class="container">
		<div class="form">
			...
			<form action="http://localhost:8080/tienda/proveedores/formularioactualizarproveedor"
				method="POST">
		...
		<h3> Resultados de la b�squeda </h3>
			...
			<c:forEach items="${lista}" var="proveedor">
				...
				<div class="form">
					...
					<form action="http://localhost:8080/tienda/proveedores/actualizarproveedor" method="POST">
					...
					<label for="contacto"> Contacto: </label> 
					<br>
					<input type="text" id="contacto" name="contacto" value="${proveedor.contacto}" >  
					<br>
					<label for="telefono"> Tel�fono: </label> 
					<br>					
