...
<body>
	...
	<div class = "form">
		...
		<form action = "http://localhost:8080/tienda/clientes/formularioborrarclientes" method = "POST">
	...
	<c:forEach items="${lista}" var="cliente">
		...
		<form action = "http://localhost:8080/tienda/vistas/clientes/borrarclientes" method = "POST">
