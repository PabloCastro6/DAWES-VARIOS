...
public class VistaMedico {
	...
	public void menuInsertarMedico() throws ClassNotFoundException, SQLException {
		...
		MedicosController controladorMedico = new MedicosController();
		int resultado = controladorMedico.insertarMedico( nombre, apellido, especialidad, licenciaMedica, telefono,
				correoElectronico);
	...
	public void menuActualizarMedico() throws ClassNotFoundException, SQLException {
		...
		MedicosController controladorMedico = new MedicosController();
		int resultado = controladorMedico.actualizarMedico(iD, nombre, apellido, especialidad, licenciaMedica, telefono,
				correoElectronico);
