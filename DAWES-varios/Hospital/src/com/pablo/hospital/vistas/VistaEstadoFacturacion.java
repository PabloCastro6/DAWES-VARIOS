...
public class VistaEstadoFacturacion {
	...
	public void menuGeneralEstadoFacturacion() throws ClassNotFoundException, SQLException {
		...
		do {
			...
			System.out.println("===========================================================");
			System.out.println("1. Buscar estado facturacion");
			System.out.println("2. Insertar estado facturacion");
			System.out.println("3. Actualizar estado facturacion ");
	...
	public void menuBuscaEstadoFacturacion() throws ClassNotFoundException, SQLException {
		...
		List<EstadoFacturacionDTO> listaEstadoFacturacion = controlarEstadoFacturacion.buscarEstadoFacturacion(id,
				estado);
	...
	public void menuInsertaEstadoFacturacion() throws ClassNotFoundException, SQLException {
		...
		int resultado = controladorFacturacion.insertarEstadoFacturacion( estado);
		if (resultado == 1) {
	...
	private void menuActualizarEstadoFacturacion() throws ClassNotFoundException, SQLException {
		...
		EstadoFacturacionController controladorFacturacion = new EstadoFacturacionController();
		int resultado = controladorFacturacion.actualizarEstadoFacturacion(iD, estado);
		if (resultado == 1) {
			System.out.println("Se ha introducido el registro con éxito");
		} else {
			System.out.println("Se ha producido un error al introducir el registro");
