...
public class CitasModelo {
	...
	public List<CitaDTO> buscaCita(String id, String pacienteID, String medicoID, String fecha, String hora,
	...
	public Integer actualizarCita(String iD, String pacienteID, String medicoID, String fecha, String hora,
			String estadoID) throws SQLException, ClassNotFoundException {

		String sql = "UPDATE citas " + "SET " + "    PacienteID = CASE WHEN ? = '' THEN PacienteID ELSE ? END, "
